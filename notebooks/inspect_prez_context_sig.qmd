...
fig_gen_dict = {
    ...
    # LDA traces
    'task_lda_trace':src.context_analysis.plot_M1_lda_traces(td_test_ambig_hold.query('epoch=="hold_move"'),ref_event='idx_goCueTime',label_colors={'RTT':'r','CST':'b'}),
    'task_lda_trace_pretask':src.context_analysis.plot_M1_lda_traces(td_test_ambig_hold.query('epoch=="hold_move_ref_cue"'),ref_event='idx_pretaskHoldTime',label_colors={'RTT':'r','CST':'b'}),
    'task_lda_trace':src.context_analysis.plot_M1_lda_traces(td_test_ambig_hold.query('epoch=="full"'),ref_event='idx_goCueTime',label_colors={'RTT':'r','CST':'b'}),
}

fig,axs = plt.subplots(1,2,figsize=(6,2), sharey=True, gridspec_kw={'width_ratios':[1,4]})
src.context_analysis.plot_separability_dynamics(td_test_ambig_hold,'Time from pretask hold (s)',ax=axs[0],time_lims=[-0.5,1],pred_name='M1_pred')
src.context_analysis.plot_separability_dynamics(td_test_ambig_hold,'Time from go cue (s)',ax=axs[1],time_lims=[-1,5],pred_name='M1_pred')
sns.despine(ax=axs[1],left=True)

fig,axs = plt.subplots(1,2,figsize=(6,2), sharey=True, gridspec_kw={'width_ratios':[1,4]})
src.context_analysis.plot_separability_dynamics(td_test_ambig_hold,'Time from pretask hold (s)',ax=axs[0],time_lims=[-0.5,1],pred_name='beh_pred')
src.context_analysis.plot_separability_dynamics(td_test_ambig_hold,'Time from go cue (s)',ax=axs[1],time_lims=[-1,5],pred_name='beh_pred')
sns.despine(ax=axs[1],left=True)
```
...
fig_gen_dict = {
    ...
    'task_beh_lda':src.context_analysis.plot_beh_lda(td_train,hue_order=['RTT','CST']),
    # LDA traces
    'task_lda_trace':src.context_analysis.plot_M1_lda_traces(td_test_cued_hold.query('epoch=="hold_move"'),ref_event='idx_goCueTime',label_colors={'RTT':'r','CST':'b'}),
    'task_lda_trace_pretask':src.context_analysis.plot_M1_lda_traces(td_test_cued_hold.query('epoch=="hold_move_ref_cue"'),ref_event='idx_pretaskHoldTime',label_colors={'RTT':'r','CST':'b'}),
    'task_lda_trace':src.context_analysis.plot_M1_lda_traces(td_test_cued_hold.query('epoch=="full"'),ref_event='idx_goCueTime',label_colors={'RTT':'r','CST':'b'}),
}

fig,axs = plt.subplots(1,2,figsize=(6,2), sharey=True, gridspec_kw={'width_ratios':[1,4]})
src.context_analysis.plot_separability_dynamics(td_test_cued_hold,'Time from pretask hold (s)',ax=axs[0],time_lims=[-0.5,1],pred_name='M1_pred')
src.context_analysis.plot_separability_dynamics(td_test_cued_hold,'Time from go cue (s)',ax=axs[1],time_lims=[-1,5],pred_name='M1_pred')
sns.despine(ax=axs[1],left=True)

fig,axs = plt.subplots(1,2,figsize=(6,2), sharey=True, gridspec_kw={'width_ratios':[1,4]})
src.context_analysis.plot_separability_dynamics(td_test_cued_hold,'Time from pretask hold (s)',ax=axs[0],time_lims=[-0.5,1],pred_name='beh_pred')
src.context_analysis.plot_separability_dynamics(td_test_cued_hold,'Time from go cue (s)',ax=axs[1],time_lims=[-1,5],pred_name='beh_pred')
sns.despine(ax=axs[1],left=True)
...
fig_gen_dict = {
    ...
    # LDA traces
    'task_lda_trace':src.context_analysis.plot_M1_lda_traces(td_test_move.query('epoch=="hold_move"'),ref_event='idx_goCueTime',label_colors={'RTT':'r','CST':'b'}),
    'task_lda_trace_pretask':src.context_analysis.plot_M1_lda_traces(td_test_move.query('epoch=="hold_move_ref_cue"'),ref_event='idx_pretaskHoldTime',label_colors={'RTT':'r','CST':'b'}),
    'task_lda_trace':src.context_analysis.plot_M1_lda_traces(td_test_move.query('epoch=="full"'),ref_event='idx_goCueTime',label_colors={'RTT':'r','CST':'b'}),
}

fig,axs = plt.subplots(1,2,figsize=(6,2), sharey=True, gridspec_kw={'width_ratios':[1,4]})
src.context_analysis.plot_separability_dynamics(td_test_move,'Time from pretask hold (s)',ax=axs[0],time_lims=[-0.5,1],pred_name='M1_pred')
src.context_analysis.plot_separability_dynamics(td_test_move,'Time from go cue (s)',ax=axs[1],time_lims=[-1,5],pred_name='M1_pred')
sns.despine(ax=axs[1],left=True)

fig,axs = plt.subplots(1,2,figsize=(6,2), sharey=True, gridspec_kw={'width_ratios':[1,4]})
src.context_analysis.plot_separability_dynamics(td_test_move,'Time from pretask hold (s)',ax=axs[0],time_lims=[-0.5,1],pred_name='beh_pred')
src.context_analysis.plot_separability_dynamics(td_test_move,'Time from go cue (s)',ax=axs[1],time_lims=[-1,5],pred_name='beh_pred')
sns.despine(ax=axs[1],left=True)
```
...
td_train,td_test_move_late,move_late_lda = src.context_analysis.apply_models(
    td_epoch,
...
```{python}
coefs = np.row_stack(M1_lda_coefs.loc[pd.Timedelta(-0.3,'s'):]).T
...
sns.lineplot(x=np.arange(S.shape[0]),y=S,ax=axs[2])

td_full['M1_sep_space'] = [neural_sig @ U[:,:num_comps] for neural_sig in td_full['M1_pca']]

task_colors={'RTT': 'r','CST': 'b'}
td_full = src.data.add_trial_time(td_full,ref_event='idx_goCueTime')
fig,axs = plt.subplots(num_comps,1)
for _,trial in td_full.groupby('task').sample(n=50).iterrows():
    for compnum in range(num_comps):
        ...
        # axs[compnum].set_xlim([-1,1])

fig,ax = plt.subplots(1,1)
for _,trial in td_full.groupby('task').sample(n=50).iterrows():
    ax.plot(
        trial['M1_sep_space'][:,0],
        trial['M1_sep_space'][:,2],
        color=task_colors[trial['task']],
        alpha=0.1
    )
...
# plot_data = (
#     td_full.copy()
#     .loc[:,['trial_id','task','trialtime','M1_sep_space']]
#     .explode(['trialtime','M1_sep_space'])
# )
# sns.lineplot()
```
