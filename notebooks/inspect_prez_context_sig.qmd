...
:::{.callout-important}
This document has been frozen in place. The git hash at time of freezing was: 324f678
:::
...
td_epoch = src.context_analysis_deprecated.extract_td_epochs(td)
```
...
td_train,td_test_ambig_hold,ambig_hold_lda = src.context_analysis_deprecated.apply_models(
    td_epoch,
...
fig_gen_dict = {
    'task_M1_pca':src.context_analysis_deprecated.plot_hold_pca(td_train,array_name='M1',hue_order=['RTT','CST']),
    'task_M1_lda':src.context_analysis_deprecated.plot_M1_lda(td_train,hue_order=['RTT','CST']),
    'task_beh':src.context_analysis_deprecated.plot_hold_behavior(td_train,hue_order=['RTT','CST']),
    'task_beh_lda':src.context_analysis_deprecated.plot_beh_lda(td_train,hue_order=['RTT','CST']),
    # LDA traces
    'task_lda_trace':src.context_analysis_deprecated.plot_M1_lda_traces(td_test_ambig_hold.query('epoch=="hold_move"'),ref_event='idx_goCueTime',label_colors={'RTT':'r','CST':'b'}),
    'task_lda_trace_pretask':src.context_analysis_deprecated.plot_M1_lda_traces(td_test_ambig_hold.query('epoch=="hold_move_ref_cue"'),ref_event='idx_pretaskHoldTime',label_colors={'RTT':'r','CST':'b'}),
    'task_lda_trace':src.context_analysis_deprecated.plot_M1_lda_traces(td_test_ambig_hold.query('epoch=="full"'),ref_event='idx_goCueTime',label_colors={'RTT':'r','CST':'b'}),
}

fig,axs = plt.subplots(1,2,figsize=(6,2), sharey=True, gridspec_kw={'width_ratios':[1,4]})
src.context_analysis_deprecated.plot_separability_dynamics(td_test_ambig_hold,'Time from pretask hold (s)',ax=axs[0],time_lims=[-0.5,1],pred_name='M1_pred')
src.context_analysis_deprecated.plot_separability_dynamics(td_test_ambig_hold,'Time from go cue (s)',ax=axs[1],time_lims=[-1,5],pred_name='M1_pred')
sns.despine(ax=axs[1],left=True)

fig,axs = plt.subplots(1,2,figsize=(6,2), sharey=True, gridspec_kw={'width_ratios':[1,4]})
src.context_analysis_deprecated.plot_separability_dynamics(td_test_ambig_hold,'Time from pretask hold (s)',ax=axs[0],time_lims=[-0.5,1],pred_name='beh_pred')
src.context_analysis_deprecated.plot_separability_dynamics(td_test_ambig_hold,'Time from go cue (s)',ax=axs[1],time_lims=[-1,5],pred_name='beh_pred')
sns.despine(ax=axs[1],left=True)
```
...
td_train,td_test_cued_hold,cued_hold_lda = src.context_analysis_deprecated.apply_models(
    td_epoch,
    train_epochs=['hold'],
    test_epochs=['hold_move','hold_move_ref_cue','full'],
)
...
fig_gen_dict = {
    ...
    'task_beh_lda':src.context_analysis_deprecated.plot_beh_lda(td_train,hue_order=['RTT','CST']),
    # LDA traces
    'task_lda_trace':src.context_analysis_deprecated.plot_M1_lda_traces(td_test_cued_hold.query('epoch=="hold_move"'),ref_event='idx_goCueTime',label_colors={'RTT':'r','CST':'b'}),
    'task_lda_trace_pretask':src.context_analysis_deprecated.plot_M1_lda_traces(td_test_cued_hold.query('epoch=="hold_move_ref_cue"'),ref_event='idx_pretaskHoldTime',label_colors={'RTT':'r','CST':'b'}),
    'task_lda_trace':src.context_analysis_deprecated.plot_M1_lda_traces(td_test_cued_hold.query('epoch=="full"'),ref_event='idx_goCueTime',label_colors={'RTT':'r','CST':'b'}),
}

fig,axs = plt.subplots(1,2,figsize=(6,2), sharey=True, gridspec_kw={'width_ratios':[1,4]})
src.context_analysis_deprecated.plot_separability_dynamics(td_test_cued_hold,'Time from pretask hold (s)',ax=axs[0],time_lims=[-0.5,1],pred_name='M1_pred')
src.context_analysis_deprecated.plot_separability_dynamics(td_test_cued_hold,'Time from go cue (s)',ax=axs[1],time_lims=[-1,5],pred_name='M1_pred')
sns.despine(ax=axs[1],left=True)

fig,axs = plt.subplots(1,2,figsize=(6,2), sharey=True, gridspec_kw={'width_ratios':[1,4]})
src.context_analysis_deprecated.plot_separability_dynamics(td_test_cued_hold,'Time from pretask hold (s)',ax=axs[0],time_lims=[-0.5,1],pred_name='beh_pred')
src.context_analysis_deprecated.plot_separability_dynamics(td_test_cued_hold,'Time from go cue (s)',ax=axs[1],time_lims=[-1,5],pred_name='beh_pred')
sns.despine(ax=axs[1],left=True)
...
td_train,td_test_move,move_lda = src.context_analysis_deprecated.apply_models(
    td_epoch,
    train_epochs=['move'],
    test_epochs=['hold_move','hold_move_ref_cue','full'],
)
...
fig_gen_dict = {
    ...
    # LDA traces
    'task_lda_trace':src.context_analysis_deprecated.plot_M1_lda_traces(td_test_move.query('epoch=="hold_move"'),ref_event='idx_goCueTime',label_colors={'RTT':'r','CST':'b'}),
    'task_lda_trace_pretask':src.context_analysis_deprecated.plot_M1_lda_traces(td_test_move.query('epoch=="hold_move_ref_cue"'),ref_event='idx_pretaskHoldTime',label_colors={'RTT':'r','CST':'b'}),
    'task_lda_trace':src.context_analysis_deprecated.plot_M1_lda_traces(td_test_move.query('epoch=="full"'),ref_event='idx_goCueTime',label_colors={'RTT':'r','CST':'b'}),
}

fig,axs = plt.subplots(1,2,figsize=(6,2), sharey=True, gridspec_kw={'width_ratios':[1,4]})
src.context_analysis_deprecated.plot_separability_dynamics(td_test_move,'Time from pretask hold (s)',ax=axs[0],time_lims=[-0.5,1],pred_name='M1_pred')
src.context_analysis_deprecated.plot_separability_dynamics(td_test_move,'Time from go cue (s)',ax=axs[1],time_lims=[-1,5],pred_name='M1_pred')
sns.despine(ax=axs[1],left=True)

fig,axs = plt.subplots(1,2,figsize=(6,2), sharey=True, gridspec_kw={'width_ratios':[1,4]})
src.context_analysis_deprecated.plot_separability_dynamics(td_test_move,'Time from pretask hold (s)',ax=axs[0],time_lims=[-0.5,1],pred_name='beh_pred')
src.context_analysis_deprecated.plot_separability_dynamics(td_test_move,'Time from go cue (s)',ax=axs[1],time_lims=[-1,5],pred_name='beh_pred')
sns.despine(ax=axs[1],left=True)
```
...
td_train,td_test_move_late,move_late_lda = src.context_analysis_deprecated.apply_models(
    td_epoch,
...
fig,axs = plt.subplots(1,2,figsize=(6,2), sharey=True, gridspec_kw={'width_ratios':[1,4]})
src.context_analysis_deprecated.plot_any_dim_separability(
    td_full,
    signal='M1_pca',
...
M1_sep_profiles,M1_lda_coefs = src.context_analysis_deprecated.get_train_test_separability(td_full,signal='M1_pca')
# PMd_sep_profiles,PMd_lda_coefs = src.context_analysis_deprecated.get_train_test_separability(td_full,signal='PMd_pca')
# MC_sep_profiles,MC_lda_coefs = src.context_analysis_deprecated.get_train_test_separability(td_full,signal='MC_pca')
beh_sep_profiles,_ = src.context_analysis_deprecated.get_train_test_separability(td_full,signal='beh_sig')
...
```{python}
coefs = np.row_stack(M1_lda_coefs.loc[pd.Timedelta(-0.3,'s'):pd.Timedelta(2,'s')]).T
...
td_full['M1_sep_space'] = [neural_sig @ U[:,:num_comps] for neural_sig in td_full['M1_pca']]
...
axs[0].set_title('M1 separability space')
sns.despine(fig=fig,trim=True)

fig,ax = plt.subplots(1,1)
for _,trial in td_full.groupby('task').sample(n=10).iterrows():
    ax.plot(
        trial['M1_sep_space'][:,0],
        trial['M1_sep_space'][:,1],
        color=task_colors[trial['task']],
        alpha=0.1
    )
